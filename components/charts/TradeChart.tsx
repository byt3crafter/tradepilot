...
export default function TradeChart({
  ...
  useLayoutEffect(() => {
    ...
    // FIX: Cast chart to 'any' to bypass faulty type definitions where 'addCandlestickSeries' is not found.
    ...
    // FIX: Cast chart to 'any' to bypass faulty type definitions where 'addLineSeries' is not found.
  ...
  useEffect(() => {
    if (candleSeriesRef.current) {
      ...
      // FIX: Cast series to 'any' to bypass faulty type definitions where 'setMarkers' is not found.
