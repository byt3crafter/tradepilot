...
const AiDebriefPopover: React.FC<AiDebriefPopoverProps> = ({ onClose }) => {
  ...
  return (
    <div className="absolute top-full right-0 mt-2 w-72 bg-[#0A0A0A] border border-photonic-blue/20 rounded-lg shadow-2xl z-50 animate-fade-in-up origin-top-right">
