...
export interface AutobotStatus {
  ...
  limits: { maxTotalUsd: number; maxPerTradeUsd: number; dailyLossLimitUsd: number; minEdgePct?: number; orderType?: 'limit' | 'market'; maxSettlementDays?: number; maxDrawdownUsd?: number };
  todayPnlUsd?: number;
