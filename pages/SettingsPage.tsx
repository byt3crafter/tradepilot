    ...
    <Panel label="SECURITY">
      ...
      <div className="bg-jtp-raised border border-jtp-border rounded-[2px] p-4 space-y-3">
        <div className="flex items-start gap-3">
          <div className="mt-0.5 w-8 h-8 rounded-[2px] bg-jtp-blue/10 flex items-center justify-center flex-shrink-0">
...
const SettingsPage: React.FC = () => {
  ...
  const NavButton: React.FC<{ tab: SettingsSubView; label: string }> = ({ tab, label }) => {
    ...
    return (
      <button
        ...
        className={`px-3 py-[7px] text-jtp-md font-mono rounded-[2px] transition-colors w-full text-left font-medium ${
          isActive
  ...
  return (
    <div className="max-w-4xl mx-auto py-1 animate-fade-in-up">
      <div className="flex flex-col md:flex-row gap-6">
        <nav className="flex-shrink-0 md:w-44">
          ...
          <div className="hidden md:block bg-jtp-panel border border-jtp-border rounded-[2px] overflow-hidden">
